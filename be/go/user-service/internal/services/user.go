...
import (
	...
	db_model "github.com/roiciap/streaming-platform/be/go/user-service/internal/db/model"
	http_model "github.com/roiciap/streaming-platform/be/go/user-service/internal/http/model"
